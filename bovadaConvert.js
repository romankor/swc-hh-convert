...
(function () {
    ...
    var conversionRatio,
        specObj = {
            ...
            blankInfo: {
                regex: /Seat stand|Table leave user/,
                data: []
            },
            //Bovada Hand #3081774361 TBL#9737108 HOLDEM No Limit - 2015-06-21 01:56:02
            handInfo: {
                regex: /^Bovada Hand #([\d\-]+).*(HOLDEMZonePoker|HOLDEM) (Pot Limit|No Limit) - (\d+-\d+-\d+) (\d+:\d+:\d+)/,
                data: ['handNum', 'gameName', 'gameType', 'date', 'time']
            },
            ...
            dealerInfo: {
                regex: /^Dealer : Set dealer\/Bring in spot ([0-9])/,
                data: ['dealerName']
            },
            holeCards: {
                regex: /^\*\*\* HOLE CARDS \*\*\*/,
